	...
	render() {
		return (
			<div className="panel panel-default">
				...
				<ol>- When children completed the mission in 'Giving' bucket, parent will also donate 50% of the points, to teach the children the importance of giving back</ol>
				<ol>- Children can add his/her wishlist to the 'Spending' bucket, and transfer points from 'Saving' bucket to 'pay' his/her 'Spending' missions </ol>
